...
var getSummary2 = new Doo("HYERS", "YEARS", hS, vS);
var getSummary3 = new Doo("Bollu", "Bagheery", hS, vS);
var getSummary4 = new Doo("Chicken", "Turkey", hS, vS);
var getSummary5 = new Doo("Fishy", "Birdy", hS, vS);
var getSummary6 = new Doo("Ticky", "Vikiych", hS, vS);
...
element6.textContent = "Home Score: " + hS;
